...
class _LanguagePageState extends State<LanguagePage> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const SingleChildScrollView(
            child: ListBody(
              children: [
                Text('Language Changed, please restart the app'),
              ],
            ),
          ),
          actions: [
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SettingCubit, SettingState>(builder: (context, state) {
      print('xk993 BlocBuilder<SettingCubit ${state.appLanguageCode}');
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              Padding(
                                  ...
                                  child: Text("lbl_english_language".tr,
                              ...
                              Radio(
                                ...
                                onChanged: (dynamic value) {
                                  setState(() {
                                    BlocProvider.of<SettingCubit>(context).setAppLanguage(value: 'en');
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                      ...
                                      child: Text("lbl_arabic_language".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                  ...
                                  Radio(
                                    ...
                                    onChanged: (dynamic value) {
                                      setState(() {
                                        BlocProvider.of<SettingCubit>(context).setAppLanguage(value: 'ar');
